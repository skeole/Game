...
class Background(object):
    ...
    def update_hitbox(self):
        self.hitbox1 = []
        self.hitbox1.append([0, self.height/2, self.width, self.height/2])
        self.hitbox1.append([self.width, self.height/2, self.width, self.height])
        self.hitbox1.append([self.width, self.height, 0, self.height])
        self.hitbox1.append([0, self.height, 0, self.height/2])
